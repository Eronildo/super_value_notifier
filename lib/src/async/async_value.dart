...
extension AsyncValueX<T> on AsyncValue<T> {
  ...
  /// Whether the associated async value was forced to recompute even though
  /// none of its dependencies has changed, after at least one [value]/[error] was emitted.
  /// 
  /// See also [isReloading].
  bool get isRefreshing =>
      isLoading && (hasValue || hasError) && this is! AsyncLoading;

  /// Whether the associated async value was recomputed because of a dependency change, 
  /// after at least one [value]/[error] was emitted.
  ///
  ...
  ///
  /// In the event that an [AsyncValue] is in multiple states at once,
  ...
  ///   should be invoked if an async value rebuilds.
  ...
  ///   should be invoked if an async value rebuilds because of refresh.
  ///   In that situation, [when] will try to invoke either [error]/[data]
  ///   with the previous state.
  ///
